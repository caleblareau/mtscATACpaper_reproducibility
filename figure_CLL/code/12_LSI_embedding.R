...
seReference <-readRDS("../../../mtscATACpaper_large_data_files/intermediate/public_atac_pbmc_5k_ng.rds")
...
save(important_df, umap, lsiPeaks, means_lsi, lsiReference, file = "../output/25March2020_projection_5k_CLL.rda")
