...
peaks_pan_heme <-diffloop::bedToGRanges("../data/")
...
# Use an inclusive FRIP threshold for all samples to not remove specific cell types
importExperiment("CD34_500_Day08", peaks_pan_heme, 0.25)
importExperiment("CD34_500_Day14", peaks_pan_heme, 0.25)
importExperiment("CD34_800_Day08", peaks_pan_heme, 0.25)
importExperiment("CD34_800_Day14", peaks_pan_heme, 0.25)
importExperiment("CD34_800_Day20", peaks_pan_heme, 0.25)
