...
rbind(read.table("../output/data1_meta.tsv", header = TRUE), 
      read.table("../output/data6_meta.tsv", header = TRUE)) %>% dplyr::filter(assign == "TF1") %>%
  dplyr::filter(mean_cov > 50) -> TF_cells_df
...
var_order <- c("8002C>T", "7789G>C",
               "13708G>A", "627G>A", "14905G>A", "5560G>A", "1793G>A", "9493G>A","12433C>T","12316G>A",
               "3901G>A", "10552C>T","7316G>A", "1888G>A", "6021G>A", "6713C>T",  "2643G>A",
               "4037G>A",
               ...
               "7256C>T",  "7598G>A",
               "309C>T",  "7847G>A", 
               "14569G>A","2954C>A", "5970G>A",'7521G>A',
               "11196G>A", 
               
               "6027G>A","2040G>A","1045G>A",
               "5324C>T","2789C>T",
               "2573G>A",
               "15765G>A",
               "8684C>T", "10458C>T"
