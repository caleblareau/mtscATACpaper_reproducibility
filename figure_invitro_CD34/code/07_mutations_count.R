...
c500 <- readRDS("misc_mito/filtered_SE_CD34-500.rds")
...
c800 <- readRDS("misc_mito/filtered_SE_CD34-800.rds")
...
cowplot::ggsave(p_out, file = "plots/cells_CDF_like.pdf", width = 3.5, height = 1.8)
