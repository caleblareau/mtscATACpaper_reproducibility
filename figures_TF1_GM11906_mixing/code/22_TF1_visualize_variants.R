...
pdf(paste0("../output/plots/final_TF1.pdf"), width=4, height=3)
...
png(paste0("../output/plots/final_TF1_nosqrt_10.png"), width=4, height=3, unit = "in", res = 500)
